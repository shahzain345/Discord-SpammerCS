...
if __name__ == "__main__":
    ...
    tken = input(f"[{colorama.Style.BRIGHT}{colorama.Fore.GREEN}+{colorama.Style.RESET_ALL}]{colorama.Style.BRIGHT}{colorama.Fore.BLUE} Enter your token you want to scrape with: {colorama.Style.RESET_ALL}")
    channelId = input(f"[{colorama.Style.BRIGHT}{colorama.Fore.GREEN}+{colorama.Style.RESET_ALL}]{colorama.Style.BRIGHT}{colorama.Fore.BLUE} Enter your channel ID: {colorama.Style.RESET_ALL}")
    guildId = input(f"[{colorama.Style.BRIGHT}{colorama.Fore.GREEN}+{colorama.Style.RESET_ALL}]{colorama.Style.BRIGHT}{colorama.Fore.BLUE} Enter your server ID: {colorama.Style.RESET_ALL}")
    members = scrape(tken, guildId, channelId)
    for member in members:
        print(f"[{colorama.Style.BRIGHT}{colorama.Fore.BLUE}+{colorama.Style.RESET_ALL}]{colorama.Style.BRIGHT}{colorama.Fore.GREEN} Scrapped: {member}{colorama.Style.RESET_ALL}")
        open("members.txt", "a").write(f"{member}\n")
    exit()